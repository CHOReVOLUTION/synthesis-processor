...
public class CoordinationDelegateGeneratorClient extends SynthesisProcessorWebClientConfiguration
		implements CoordinationDelegateGenerator {
	...
	public CoordinationDelegateGeneratorResponse generateWSDLCoordinationDelegateProsumer(
		...
		client.path("generateWSDLCoordinationDelegateProsumer");
		
		try {
			return client.post(coordinationDelegateGeneratorRequest, CoordinationDelegateGeneratorResponse.class);
	...
	public CoordinationDelegateGeneratorResponse generateWSDLCoordinationDelegateClient(
		...
		WebClient client = super.setupClient();
		client.path("generateWSDLCoordinationDelegateClient");
	...
	public CoordinationDelegateGeneratorResponse generateCoordinationDelegateProsumer(
		...
		WebClient client = super.setupClient();
		client.path("generateCoordinationDelegateProsumer");
	...
	public CoordinationDelegateGeneratorResponse generateCoordinationDelegateClient(
		...
		WebClient client = super.setupClient();
		client.path("generateCoordinationDelegateClient");
	...
	public CoordinationDelegateGeneratorResponse generateConsumer(
		...
		WebClient client = super.setupClient();
		client.path("generateCoordinationDelegateConsumer");
