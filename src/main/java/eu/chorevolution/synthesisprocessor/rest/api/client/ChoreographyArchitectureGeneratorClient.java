...
public class ChoreographyArchitectureGeneratorClient extends SynthesisProcessorWebClientConfiguration
		implements ChoreographyArchitectureGenerator {

	public ChoreographyArchitectureGeneratorClient(String host) {
		super(host);
	}
	...
	public ChoreographyArchitectureGeneratorResponse generateChoreographyArchitecture(
		...
		client.path("generateChoreographyArchitecture");

		try {
			return client.post(choreographyArchitectureGeneratorRequest,
					ChoreographyArchitectureGeneratorResponse.class);
