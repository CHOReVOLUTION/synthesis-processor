...
public class ChoreographyValidatorClient extends SynthesisProcessorWebClientConfiguration
		implements ChoreographyValidator {
	...
	public ChoreographyValidatorResponse validateChoreography(
		...
		client.path("validateChoreography");

		try {
			return client.post(choreographyValidatorRequest,
					ChoreographyValidatorResponse.class);
