...
public class SynthesisProcessorClientUtils {
	
	public static byte[] getArtifactContent(String location) throws SynthesisProcessorBusinessException {
		try {
			SynthesisProcessorClient client = new SynthesisProcessorClient(Configuration.get(Configuration.APPLICATION_BASE_URI));
			...
			return client.download(choreographyName, directory, artifactName);
		} catch (Exception e) {
