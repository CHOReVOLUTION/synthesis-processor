...
public class ChoreographyValidatorImplTest {
	...
	private static Logger logger = LoggerFactory.getLogger(ChoreographyValidatorImplTest.class);
	...
	public void validateChoreography() {
		try {
			...
			ChoreographyValidator choreographyValidator = new ChoreographyValidatorImpl();  
			ChoreographyValidatorResponse response = choreographyValidator.validateChoreography(request);
