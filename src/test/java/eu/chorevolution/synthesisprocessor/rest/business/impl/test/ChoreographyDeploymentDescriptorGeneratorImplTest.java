...
public class ChoreographyDeploymentDescriptorGeneratorImplTest {
	...
	private static Logger logger = LoggerFactory.getLogger(ChoreographyDeploymentDescriptorGeneratorImplTest.class);
	...
	public void getChoreographyDeploymentDescriptorContent() {
		try {
			...
			ChoreographyDeploymentDescriptorGenerator choreographyDeploymentDescriptorGenerator = new ChoreographyDeploymentDescriptorGeneratorImpl(); 
			ChoreographyDeploymentDescriptorGeneratorResponse response = choreographyDeploymentDescriptorGenerator.generateChoreographyDeploymentDescriptor(request);
