...
public class ChoreographyArchitectureGeneratorImplTest {
	...
	private static Logger logger = LoggerFactory.getLogger(ChoreographyArchitectureGeneratorImplTest.class);
	...
	public void generateChoreographyArchitecture() {
		try {
			...
			request.setBpmn2Content(
					FileUtils.readFileToByteArray(new File(TEST_RESOURCES + "wp5" + BPMN2_FILE_EXTENSION)));
			...
			ChoreographyArchitectureGenerator choreographyArchitectureGenerator = new ChoreographyArchitectureGeneratorImpl();
			ChoreographyArchitectureGeneratorResponse response = choreographyArchitectureGenerator
					.generateChoreographyArchitecture(request);
